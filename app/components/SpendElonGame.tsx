...
type SpendElonGameProps = {
  initialBalance: number;
  worthBillions: string;
  lastUpdated: string;   // ISO date string from Forbes API
  source: 'forbes' | 'fallback';
};

export default function SpendElonGame({
  initialBalance,
  worthBillions,
  lastUpdated,
  source,
  ...
  // Format the Forbes lastUpdated date nicely
